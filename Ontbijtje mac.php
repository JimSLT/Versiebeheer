...
<html> 
	<head>
		<meta charset="UTF-8">
		<title>Ontbijtje van de Mac</title>
		<link rel="stylesheet" href="style.css" type="text/css">
		
	</head>
	<body>
	<img src="ontbijtje.png" alt="ontbijtje">
	<h1> Ontbijtje Mac</h1>
	<p>
	Je kunt tot 11.00 uur genieten van een ontbijt bij McDonald’s.<br>
	Het ontbijt wordt verkocht in ruim 200 restaurants. <br>
	Wil je zeker weten of een restaurant een ontbijt serveert, informeer dan vooraf even bij het restaurant.
	</p>
		<p> WIE WENS JIJ EEN LEKKER BEGIN VAN DE DAG?
...
Als je problemen ondervindt bij het inspreken van je audioboodschap kun je hierbij worden geholpen door een tekst- of audiobericht naar @mcdonaldsnederland te sturen met je vraag.</p>

 

<p>ONTBIJTACTIE – Wie wens jij een lekker begin van de dag?</p>
...
<p>3. Inspreken van Audioboodschap
...
3.7. Het is een deelnemer niet toegestaan de Audioboodschap voorafgaand aan de lancering van de Ontbijtradiocommercial openbaar te maken dan wel via eigen (social media) kana-len te verspreiden.</p>
...
4.8. De Prijs is niet omwisselbaar en niet in te wisselen voor geld.</p>
